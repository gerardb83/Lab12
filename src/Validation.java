...
public class Validation {
	...
	public static int getDynamicRangeInt(Scanner scnr, String prompt, int lowRange, ArrayList<Car> array, String rangeString) {
		System.out.println(prompt);
		int answer;
		do {
			while (!scnr.hasNextInt()) {
	...
	public static int getDynamicRangeInt(Scanner scnr, String prompt, int lowRange, ArrayList<Car> array, int exception, String rangeString) {
		System.out.println(prompt);
		int answer;
		do {
			while (!scnr.hasNextInt()) {
